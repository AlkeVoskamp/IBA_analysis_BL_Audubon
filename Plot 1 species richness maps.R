...
Future_rcp45 <- SR_data[c("x", "y", "GAM_CCSM4_rcp45_50_TSS", "GAM_GFDLCM3_rcp45_50_TSS", "GAM_HadGEM2ES_rcp45_50_TSS",
                          ...
                          "RF_GFDLCM3_rcp45_50_TSS", "RF_HadGEM2ES_rcp45_50_TSS")] # "RF_CCSM4_rcp45_50_TSS", 
...
Future_rcp85 <- SR_data[c("x", "y", "GAM_CCSM4_rcp85_50_TSS", "GAM_GFDLCM3_rcp85_50_TSS", "GAM_HadGEM2ES_rcp85_50_TSS",
                          ...
                          "RF_CCSM4_rcp85_50_TSS", "RF_GFDLCM3_rcp85_50_TSS", "RF_HadGEM2ES_rcp85_50_TSS")] # "RF_CCSM4_rcp26_50_TSS","RF_GFDLCM3_rcp26_50_TSS","RF_HadGEM2ES_rcp26_50_TSS"
...
Curhist <- ggplot(Base) +
  geom_freqpoly(aes(x=GAM_baseline_TSS), colour = "blue") +
  geom_freqpoly(aes(x=GBM_baseline_TSS), colour = "green") +
  geom_freqpoly(aes(x=GLM_baseline_TSS), colour = "red") +
  geom_freqpoly(aes(x=RF_baseline_TSS), colour = "black") +
...
Futhist <- ggplot(Future_rcp45) +
  geom_freqpoly(aes(x=GAM_CCSM4_rcp45_50_TSS), colour = "blue") +
  geom_freqpoly(aes(x=GAM_GFDLCM3_rcp45_50_TSS), colour = "blue") +
  geom_freqpoly(aes(x=GAM_HadGEM2ES_rcp45_50_TSS), colour = "blue") +
  
  geom_freqpoly(aes(x=GBM_CCSM4_rcp45_50_TSS), colour = "green") +
  geom_freqpoly(aes(x=GBM_GFDLCM3_rcp45_50_TSS), colour = "green") +
  geom_freqpoly(aes(x=GBM_HadGEM2ES_rcp45_50_TSS), colour = "green") +
  
  geom_freqpoly(aes(x=GLM_CCSM4_rcp45_50_TSS), colour = "red") +
  geom_freqpoly(aes(x=GLM_GFDLCM3_rcp45_50_TSS), colour = "red") +
  geom_freqpoly(aes(x=GLM_HadGEM2ES_rcp45_50_TSS), colour = "red") +
  
  #geom_freqpoly(aes(x=RF_CCSM4_rcp45_50_TSS), colour = "black") +
  geom_freqpoly(aes(x=RF_GFDLCM3_rcp45_50_TSS), colour = "black") +
